...
public class BattleScript : MonoBehaviourPun
{
    ...
    public string tagName = "PlayerDie";
    ...
    void Die()
    {
        SpinManager.counter = -1;
        playerTag.tag = tagName;
        isDead = true;
    ...
    {
     if(SpinManager.counter == 4 && isDead == true)
     {
            SceneManager.LoadScene(sceneLoss);
     }
     if (SpinManager.counter == 3 && isDead == true)
     {
            SceneManager.LoadScene(sceneWinThree);
     }
     if (SpinManager.counter == 2 && isDead == true)
     {
            SceneManager.LoadScene(sceneWinTwo);
            //StartCoroutine(TrueWinSpin());
            
        }
     if (SpinManager.counter == 1 && isDead == false)
     {
            SceneManager.LoadScene(sceneWinOne);
     }
    }

    IEnumerator TrueWinSpin()
    {
