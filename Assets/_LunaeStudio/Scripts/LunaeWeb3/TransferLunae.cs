...
public class TransferLunae : MonoBehaviour
{
    /*
    public string setChainId;
    
    public string setContract;

    public string setToAccount;

    public string setAmount;
    */
    public GameObject panelStart;

    public GameObject panelStartTransfer;

    public GameObject panelStartError;
    ...
    async public void OnTransfer20()
    {
        ...
        try
        {
            ...
            panelStartError.SetActive(false);
            panelStartTransfer.SetActive(false);
        }
        catch (Exception e)
        {
            panelStartTransfer.SetActive(true);
            panelStart.SetActive(false);
            panelStartError.SetActive(true);
